! function(e, t) {
    ...
    function n(e) {
        var t;
        s && (t = new Date, console.log(t.toLocaleTimeString() + "." + t.getMilliseconds() + "> " + e))
    }

    function c(e) {
        return void 0 === e ? "" : "string" == typeof e ? e : e.message
    }
    var i = (t.prototype.getBars = function(e, t, r, s) {
        var o = this,
            i = {
                symbol: e.ticker || "",
                resolution: t,
        ...
        return void 0 !== e.currency_code && (i.currencyCode = e.currency_code), new Promise(function(a, u) {
                ...
                if ("ok" === e.s || "no_data" === e.s) {
                    ...
                    if ("no_data" === e.s) r.noData = !0, r.nextTime = e.nextTime;
                        ...
                        for (var s = void 0 !== e.v, o = void 0 !== e.o, i = 0; i < e.t.length; ++i) {
                            ...
                            o && (n.open = parseFloat(e.o[i]), n.high = parseFloat(e.h[i]), n.low = parseFloat(e.l[i])), s && (n.volume = parseFloat(e.v[i])), t.push(n)
                        }
                    a({
                        bars: t,
                        meta: r
    ...
    var a = (o.prototype.subscribeBars = function(e, t, r, s) {
        ...
        if (!(0 < this._requestsPending)) {
            ...
            var e, s = this;
            for (e in this._subscribers) ! function(t) {
                s._requestsPending += 1, s._updateDataForSubscriber(t).then(function() {
                    --r._requestsPending, n("DataPulseProvider: data for #" + t + " updated successfully, pending=" + r._requestsPending)
                }).catch(function(e) {
                    --r._requestsPending, n("DataPulseProvider: data for #" + t + " updated with error=" + c(e) + ", pending=" + r._requestsPending)
                })
            }(e)
        }
    ...
    var d = (p.prototype.resolveSymbol = function(t, r) {
        var s = this;
            ...
            for (var o = r.symbol.length, i = void 0 !== r.ticker; s < o; ++s) {
                var n = r.symbol[s],
                    ...
                    u = {
                        ...
                        has_intraday: true,    // the default value of has_intraday : _(h(r, "has-intraday", s), !1) //i have forced this value to true
                        ...
                        supported_resolutions: _(h(r, "supported-resolutions", s, !0), e._datafeedSupportedResolutions),
                        force_session_rebuild: h(r, "force-session-rebuild", s),
                        has_daily: _(h(r, "has-daily", s), !0),
                        intraday_multipliers: _(h(r, "intraday-multipliers", s, !0), ["1", "5", "15", "30", "60"]),
                ...
                e._symbolsInfo[d] = u, e._symbolsInfo[n] = u, e._symbolsInfo[c] = u, void 0 !== l && (e._symbolsInfo[f(d, l)] = u, e._symbolsInfo[f(n, l)] = u, e._symbolsInfo[f(c, l)] = u), e._symbolsList.push(n)
            }
        } catch (e) {
    ...
    var b = (y.prototype.onReady = function(e) {
        var t = this;
    ...
    }, y.prototype.calculateHistoryDepth = function(e, t, r) {}, y.prototype.getMarks = function(e, t, r, s, o) {
        ...
        if (this._configuration.supports_search) {
            ...
            this._send("search", o).then(function(e) {
                return void 0 !== e.s ? (n("UdfCompatibleDatafeed: search symbols error=" + e.errmsg), void s([])) : void s(e)
            }).catch(function(e) {
        ...
        !e.supports_group_request && e.supports_search || (this._symbolsStorage = new d(this._datafeedURL, e.supported_resolutions || [], this._requester)), n("UdfCompatibleDatafeed: Initialized with " + JSON.stringify(e))
    }, y);
    ...
    var g = (P.prototype.getQuotes = function(e) {
        var s = this;
        return new Promise(function(t, r) {
            s._requester.sendRequest(s._datafeedUrl, "quotes", {
                ...
                e = c(e);
                n("QuotesProvider: getQuotes failed, error=" + e), r("network error: " + e)
            })
        })
    }, P);
    ...
    var D, S, x, C = (r(S = k, x = D = b), S.prototype = null === x ? Object.create(x) : (U.prototype = x.prototype, new U), k);
    ...
    e.UDFCompatibleDatafeed = C, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
